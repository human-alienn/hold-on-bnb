      ...
      <div className="relative z-10 max-w-7xl mx-auto">
                ...
                {category.people.map((person, index) => (
                  ...
                  >
                    ...
                    >
                      ...
                      {/* Content area - flex-1 to grow and align content to top */}
        ...
        >
          ...
          >
            ...
            >
              THEY CHOSE TO <span className="text-[#F3BA2F]">HOLD</span>. WILL YOU?
            </p>
          </div>
        </motion.div>
      </div>

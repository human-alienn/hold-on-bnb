...
export function MissionSpeechCard({ icon, title, content, delay, numberColor = '#F3BA2F', gradientIntensity = 0.2 }: MissionSpeechCardProps) {
  return (
    <motion.div
    ...
    >
      ...
      >
        {/* Background gradient overlay - varying intensity */}
        <div
          className="absolute inset-0 opacity-30"
          style={{
            background: `linear-gradient(135deg, rgba(20, 15, 5, ${gradientIntensity * 0.8}) 0%, rgba(243, 186, 47, ${gradientIntensity * 0.4}) 100%)`,
          }}
        />
        ...
        <div className="relative z-10">
          ...
          {/* Title with custom number color */}
          <h3
            className="mb-4"
            style={{
              fontSize: '1.75rem',

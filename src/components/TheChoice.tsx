            ...
            >
              ...
              <div className="relative z-10">
                ...
                <div className="space-y-1 md:space-y-3 text-left">
                  <p className="text-white/70 text-xs md:text-sm mb-2 md:mb-3" style={{ fontFamily: 'Inter, sans-serif' }}>
                    The red pill. The way out of the simulation.
                  </p>
                  <div className="flex items-start gap-1 md:gap-3">
                    <span className="text-[#F3BA2F] text-sm md:text-xl mt-0.5">•</span>
                    <span className="text-white/90 text-xs md:text-base" style={{ fontFamily: 'Inter, sans-serif' }}>
                      Understand the code. Not the noise.
                    </span>
                  </div>
                  <div className="flex items-start gap-1 md:gap-3">
                    <span className="text-[#F3BA2F] text-sm md:text-xl mt-0.5">•</span>
                    <span className="text-white/90 text-xs md:text-base" style={{ fontFamily: 'Inter, sans-serif' }}>
                      Time is your ally. We don't rush legends.
                    </span>
                  </div>
                  <div className="flex items-start gap-1 md:gap-3">
                    <span className="text-[#F3BA2F] text-sm md:text-xl mt-0.5">•</span>
                  ...
                  <div className="flex items-start gap-1 md:gap-3">
                    <span className="text-[#F3BA2F] text-sm md:text-xl mt-0.5">•</span>
                    <span className="text-white/90 text-xs md:text-base" style={{ fontFamily: 'Inter, sans-serif' }}>
                      We brew coffee. Others chase candles.
                    </span>
                  </div>
                  <div className="flex items-start gap-1 md:gap-3">
                    <span className="text-[#F3BA2F] text-sm md:text-xl mt-0.5">•</span>
                  ...
                  <p className="text-white/50 text-xs md:text-sm mt-2 md:mt-4 italic" style={{ fontFamily: 'Inter, sans-serif' }}>
          ...
          >
            ...
            >
              ...
              <div className="relative z-10">
                ...
                <div className="space-y-1 md:space-y-3 text-left">
                  <p className="text-white/60 text-xs md:text-sm mb-2 md:mb-3" style={{ fontFamily: 'Inter, sans-serif' }}>
                    The blue pill. Stay comfy in the matrix.
                  </p>
                  <div className="flex items-start gap-1 md:gap-3">
                    <span className="text-blue-400 text-sm md:text-xl mt-0.5">•</span>
                  ...
                  <div className="flex items-start gap-1 md:gap-3">
                    <span className="text-blue-400 text-sm md:text-xl mt-0.5">•</span>
                    <span className="text-white/70 text-xs md:text-base" style={{ fontFamily: 'Inter, sans-serif' }}>
                      Mortgage. Subscriptions. Debt.
                    </span>
                  </div>
                  <div className="flex items-start gap-1 md:gap-3">
                    <span className="text-blue-400 text-sm md:text-xl mt-0.5">•</span>
                    <span className="text-white/70 text-xs md:text-base" style={{ fontFamily: 'Inter, sans-serif' }}>
                      Another hype token. Same ending.
                    </span>
                  </div>
                  <div className="flex items-start gap-1 md:gap-3">
                    <span className="text-blue-400 text-sm md:text-xl mt-0.5">•</span>
                  ...
                  <p className="text-white/40 text-xs md:text-sm mt-2 md:mt-4 italic" style={{ fontFamily: 'Inter, sans-serif' }}>
                    → You'll wake up someday… maybe.
                  </p>
                </div>
              </div>
            </motion.button>
